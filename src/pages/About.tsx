            ...
            <div className="space-y-6 animate-fade-in-up">
              <div className="space-y-6">
                <p className="text-lg leading-relaxed text-foreground">
                  Компания ООО «КорИнфоТех», являющаяся на сегодняшний день, одним из предприятий в сфере IT, была создана в 2011 году. Основной деятельностью компании является создание современной информационной и телекоммуникационной инфраструктуры предприятий.
                </p>
                <p className="text-lg leading-relaxed text-foreground">
